...
- a Token is what is used to let the back-end know that we are login or not
- [ ] What steps can you take in your web apps to keep your data secure?
- require a login and have protected routes
- [ ] Describe how web servers work.
- A Web servers is a program that uses HTTP to serve the files that form a webpage in response to users request that are mane
